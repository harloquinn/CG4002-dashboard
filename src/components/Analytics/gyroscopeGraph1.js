...
export default class GyroscopeComponent1 extends Component {
  constructor() {
    super();
    this.state = {
      timeArray: [0],
  ...
  render() {
    const GyroscopeComponent1 = createPlotlyComponent(Plotly);
    ...
    return (
      <AnalyticsStyles>
          <GyroscopeComponent1 className="accelerometer-graph" data={[
