...
export default class AccelerometerComponent2 extends Component {
  constructor() {
    super();
    this.state = {
      timeArray: [0],
  ...
  render() {
    const AccelerometerComponent2 = createPlotlyComponent(Plotly);
    ...
    return (
      <AnalyticsStyles>
          <AccelerometerComponent2 className="accelerometer-graph" data={[
